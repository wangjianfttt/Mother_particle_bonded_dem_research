...
| External author metadata for live system | `external_pending` | Missing coauthor e-mail count = 7; two public candidate e-mails require author confirmation. | `manuscript/computational_particle_mechanics_coauthor_email_request_zh_en.docx; docs/cpm_author_email_public_lookup_20260704.md` | Collect or confirm coauthor e-mails before final system submission if the live system requires them. |
