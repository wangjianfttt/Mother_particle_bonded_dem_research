...
| Packed-bed compression and crushed-bed consequences | `ZaccariLoFrano2009CeramicPebbleBeds; PreliminaryLi4SiO4StructuralPerformance; CrushedPebblePressureDrop2024; Fang2026Li4SiO4BedCrushing` | Bed stiffness, compaction, breakage-ratio and pressure-drop trends. | Bed-level responses do not resolve the chronological source of the first localized internal damage. | Fig. 4; Table 2; tables/pb007_macro_topology_event_metrics.csv; data/figure_source/fig4_fracture_sequence_pilot_events.csv | Finite 100-particle windows, not converged failure probability. |
