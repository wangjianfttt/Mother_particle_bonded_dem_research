...
The live Computational Particle Mechanics submission may require e-mail
addresses for every author. The local manuscript records currently contain
only the corresponding author e-mail:

- Jian Wang: `wjfttt@mail.ustc.edu.cn`

This note records a limited public lookup for the seven missing coauthor
e-mail fields. It is a submission-support note, not an authorization record.
Any candidate e-mail below should be confirmed by the corresponding author or
the coauthor before final entry into the journal submission system.

## Result

| Author | Local status | Public candidate | Confidence | Use rule |
|---|---|---|---|---|
...
- Gang Shen: the SAGE article page for "State recognition based adaptive
  ...
  `shenganghit@163.com`.
- Haishun Deng: the Scientific Reports/PMC article "Structural optimization
  and flow field analysis of turbomolecular pump based on a new performance
  prediction algorithm" lists Haishun Deng and includes the public e-mail
  candidate `269469122@qq.com`.
