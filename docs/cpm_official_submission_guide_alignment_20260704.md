...
| Highlights | ScienceDirect Guide for Authors: highlights are required for this journal family workflow. | `submission_packages/computational_particle_mechanics_upload_ready/02_highlights.docx` | `ready` | Upload the DOCX or paste the five highlights from editorial fields. |
| Graphical abstract and artwork | ScienceDirect Guide for Authors: graphical abstract/artwork files should be supplied separately; generative-AI artwork is not permitted. | `submission_packages/computational_particle_mechanics_upload_ready/03_graphical_abstract.*; scripts/plot_apt_graphical_abstract.py` | `ready` | Use the script-generated graphical abstract files; do not upload generative-AI artwork. |
