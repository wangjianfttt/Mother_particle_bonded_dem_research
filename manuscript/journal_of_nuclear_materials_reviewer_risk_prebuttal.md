...
| Use of AI-assisted tools must be declared clearly | Elsevier requires transparent declaration when AI tools assisted writing or code workflows | Declarations file and manuscript include a generative-AI statement assigning responsibility to authors | Keep the declaration concise and author-verified | Corresponding author must confirm final wording before upload |
