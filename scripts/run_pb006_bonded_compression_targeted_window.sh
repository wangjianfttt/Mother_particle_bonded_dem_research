...
case_id="${1:-PB-006-bonded-randompack-1000-targeted-window}"
relax_steps="${2:-1000}"
compress_steps="${3:-40000}"
top_vz="${4:--0.5}"
thermo_every="${5:-1000}"
pre_window_steps="${6:-23000}"
...
"${runner[@]}" -in in.pb006_bonded_compression_targeted_window.lmp \
