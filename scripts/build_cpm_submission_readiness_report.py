...
REQUIRED_REPRO_SUPPORT = [
    ...
    "repaired_submission_package/docs/cpm_live_submission_action_sheet_20260704.md",
    "repaired_submission_package/docs/cpm_live_submission_action_sheet_20260704.csv",
    "repaired_submission_package/docs/cpm_live_submission_action_sheet_20260704.json",
    "repaired_submission_package/docs/cpm_final_pdf_visual_qa_20260704.md",
    "repaired_submission_package/docs/cpm_final_pdf_visual_qa_20260704.json",
    "repaired_submission_package/docs/pdf_visual_qa/cpm_final_submission_20260704/contact_sheet.png",
    "repaired_submission_package/docs/cpm_live_submission_packet_20260704.md",
    ...
    "repaired_submission_package/manuscript/computational_particle_mechanics_individual_contact_messages.docx",
    "repaired_submission_package/manuscript/computational_particle_mechanics_individual_contact_messages.md",
    "repaired_submission_package/manuscript/computational_particle_mechanics_individual_contact_messages.txt",
    "repaired_submission_package/manuscript/computational_particle_mechanics_individual_contact_messages.csv",
    ...
    "repaired_submission_package/manuscript/computational_particle_mechanics_live_submission_checklist.docx",
    "repaired_submission_package/manuscript/computational_particle_mechanics_live_submission_checklist.md",
    ...
    "repaired_submission_package/scripts/build_cpm_live_submission_action_sheet.py",
    "repaired_submission_package/scripts/build_cpm_final_pdf_visual_qa.py",
