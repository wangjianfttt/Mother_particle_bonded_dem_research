...
- `submission_packages/jnm_repository_deposit_FROZEN_20260613_11c5ba82/journal_of_nuclear_materials_reproducibility_package.zip`
- Current verified package size/count: 121 files in the public reproducibility package
- Frozen SHA256: `11c5ba82a7912540861437e4d30c589cb4ff65afaed2a7bc63d6c685a7a95fc7`

Keep or upload the checksum file:

- `submission_packages/jnm_repository_deposit_FROZEN_20260613_11c5ba82/journal_of_nuclear_materials_reproducibility_package.zip.sha256`

Run `submission_packages/jnm_repository_deposit_FROZEN_20260613_11c5ba82/VERIFY_BEFORE_UPLOAD.sh` before upload. The staging folder remains useful for generation and audit, but the frozen folder is the stable upload source.
...
- `submission_packages/jnm_repository_deposit_FROZEN_20260613_11c5ba82/journal_of_nuclear_materials_repository_metadata_zenodo.json`

Use the Chinese author-side upload checklist if needed:

- `submission_packages/jnm_repository_deposit_FROZEN_20260613_11c5ba82/jnm_repository_deposit_action_checklist_zh.md`
