...
The template-generation, run-control and post-processing scripts are included in the reduced reproducibility package under \texttt{scripts/}, with representative DEM input files under \texttt{simulations/}. Compiler details and build flags should be recorded in the repository metadata before final upload.
...
References are maintained in \texttt{manuscript/references.bib}. DOI, year and publisher-title metadata were checked against Crossref on 2026-05-31; the audit table is stored as \texttt{tables/reference\_crossref\_audit\_20260531.csv}.
