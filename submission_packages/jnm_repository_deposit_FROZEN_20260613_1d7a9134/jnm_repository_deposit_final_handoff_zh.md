...
- 上传文件：`submission_packages/jnm_repository_deposit_FROZEN_20260613_1d7a9134/journal_of_nuclear_materials_reproducibility_package.zip`
- 文件大小：9.28 MiB
- SHA256：`1d7a9134c432cb50ecc968e4ee14428ca4fd378e50d97ffc36bdedaa30693039`

建议同时上传或在仓库描述中记录校验文件：

- 校验文件：`submission_packages/jnm_repository_deposit_FROZEN_20260613_1d7a9134/journal_of_nuclear_materials_reproducibility_package.zip.sha256`
- 校验文件 SHA256：`1df4904a338776cc3310fe33fa491aadae3a7a44d9650ef3f254628f2d395eb4`

上传前建议在 frozen 目录内执行一次校验，并保留 staging 检查作为生成一致性审计：

```bash
cd submission_packages/jnm_repository_deposit_FROZEN_20260613_1d7a9134
...
- 当前外部 blocker：repository DOI/stable URL
